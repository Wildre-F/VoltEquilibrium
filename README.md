...
> ⚠️ **This project is currently under active development. Features and documentation will continue to evolve.**
...
**Additional Services**
- 🌤️ [Open-Meteo Weather API](https://open-meteo.com/) — free weather forecasting for power predictions
...
|---|---|---|
| 📡 **IoT Device Connect** | Connect green energy devices via MQTT | 🚧 In Progress |
| 📊 **Energy Dashboard** | Real-time analytics for all your devices | 🚧 In Progress |
| 🌤️ **Power Predictions** | Weather-based forecasting of energy output | 🚧 In Progress |
| ⚡ **Efficiency Insights** | Monitor and optimise device performance | 🚧 In Progress |
| 💬 **Community Chat** | Discuss energy topics with other users | 🚧 In Progress |
| 🔋 **Power Share** | Send excess energy over the grid to your community | 🔜 Coming Soon |
...
- [ ] Weather API power prediction engine
- [ ] Community chat feature
- [ ] Power Share grid feature
- [ ] Full deployment
